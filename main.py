...
class StartPage(tk.Frame):##E0FFFF
    def __init__(self, master):#anchor=tk.CENTER, 
        ...
        # t1 = theme的實體
        command=lambda: master.switch_frame(t2)).place(x=338, y=220)
...
class Theme(tk.Frame):
    def __init__(self, theme_name):
        ...
        tk.Button(self, text="確定", font=('微軟正黑體', 12, "bold"), relief ="groove",command=print('1')).place(y=320, x=355)
...
t2 = Theme2(mainwin, ['讚讚主題',['a','b','c']])

t2

mainwin.switch_frame(StartPage)
